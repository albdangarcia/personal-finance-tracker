      ...
      data: [
        {
          ...
          frequency: "MONTHLY",
          startDate: new Date(`${calculateDate(0)}-01`),
          yearMonth: `${calculateDate(0)}`,
          incomeType: "REGULAR",
          userId: userId.id,
        },
        {
        ...
        },
        {
          ...
          startDate: new Date(`${calculateDate(0)}-15`),
          yearMonth: `${calculateDate(0)}`,
      ...
      data: [
        {
          ...
          userId: userId.id,
          yearMonth: `${calculateDate(0)}`,
          date: new Date(`${calculateDate(0)}-15`),
        },
        {
        ...
        },
        {
          ...
          amount: 10,
          userId: userId.id,
          yearMonth: `${calculateDate(-1)}`,
          date: new Date(`${calculateDate(-1)}-15`),
        },
        {
        ...
        },
        {
          ...
          amount: 20,
          userId: userId.id,
          yearMonth: `${calculateDate(-2)}`,
          date: new Date(`${calculateDate(-2)}-15`),
        },
        {
        ...
        },
        {
          ...
          amount: 20,
          userId: userId.id,
          yearMonth: `${calculateDate(-3)}`,
          date: new Date(`${calculateDate(-3)}-15`),
        },
        {
        ...
        },
        {
          ...
          amount: 70,
          userId: userId.id,
          yearMonth: `${calculateDate(-4)}`,
          date: new Date(`${calculateDate(-4)}-15`),
        },
        {
  ...
  try {
    await prisma.debtPayment.createMany({
      data: [
        {
          amount: 200,
          date: new Date(`${calculateDate(0)}-1`),
